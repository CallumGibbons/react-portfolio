...
const ProjectCard = styled("div")({
  ...
  width: "30vw", // Fixed width for the card
  ...
  overflow: "hidden",
  backgroundColor: "rgba(0, 0, 0, 0.6)", // Dark background color for the card
  opacity: "0.6",
});
...
const Projects = () => {
  ...
  const projectList = [
    ...
    },
    {
      ...
      description:
        "Built using correct version control and modern coding standards, and deployed live using a CI pipeline.",
      image: "portfolio.png",
      codeLink: "#",
      previewLink: "#",
    },
  ...
  return (
    <ProjectsContainer>
      ...
      >
        <Slider {...settings}>
          {" "}
          {/* Slick carousel component with settings */}
